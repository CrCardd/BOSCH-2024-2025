...
(92790062, 'Jo�o Manfredo', 'Andrea', '2001-09-26', 12500, 1),
(91004090, 'D�bora Junior', 'Andrea', '1999-03-02', 15600, 1),
(94566222, 'Carla Rodrigues', 'Andrea', '1990-10-04', 20000, 1),
(96334100, 'Maciel Oliveira', 'Andrea', '1995-12-06', 16500, 1),
(97885245, 'Guilherme Gon�alves', 'Marcos', '2010-05-13', 9000, 2),
...
(97854318, 'Ot�vio Luis', 'Captu', '2017-05-19', 9200, 4),
(94862122, 'Luisa Ot�via', 'Captu', '2002-11-11', 10500, 4),
...
AS
	...
	(
		SELECT 
			D.Nome 'Departamento',
			COUNT(F.Salario) 'Quantidade de funcion�rios'
...
--SELECT * FROM search_func_letter('J')



SELECT * FROM Funcionario WHERE Lider = 'Jonas'